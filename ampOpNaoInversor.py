...
class entradaNaoInversorAmpOp(wx.Dialog):
    """
    Implementa a tela de entrada de parametros de projeto do inversor com amp op
    """
    def __init__(self):
            
        wx.Dialog.__init__(self, None, -1, _('No Inverter Amplifier Specifications'),size=(300, 150)) #inicializacao do dialogo
        ...
        self.static2= wx.StaticText(self, -1, "Rs:")  #objeto texto statico 
        self.static2.SetToolTipString(_("Signal source impedance, ohms"))
        self.static2.SetForegroundColour(wx.BLUE)
        self.rsTxt = wx.TextCtrl(self, TXT_RS,'1000',size=(60,20), style=wx.TE_CENTRE)  
        self.sizer10.Add(self.static2,flag= wx.RIGHT , border = 2)        #insere os conteudos dos sizer horizontais
        self.sizer10.Add(self.rsTxt,flag= wx.RIGHT , border = 10)        #insere os conteudos dos sizer horizontais 

        self.static2= wx.StaticText(self, -1, "Rf:")  #objeto texto statico 
        self.static2.SetToolTipString(_("Feedback resistor . Tipical values 1K - 100K ohms"))
        self.static2.SetForegroundColour(wx.BLUE)
        self.rfTxt = wx.TextCtrl(self, TXT_RF,'10000',size=(60,20), style=wx.TE_CENTRE)  
        self.sizer10.Add(self.static2,flag= wx.RIGHT , border = 2)        #insere os conteudos dos sizer horizontais
        self.sizer10.Add(self.rfTxt,flag= wx.RIGHT , border = 10)        #insere os conteudos dos sizer horizontais 
...
class saidaAmpOpNoInverter(wx.Dialog):

    def __init__(self,Ri,Rf,Rp,fcp,tr):
        ...
        self.staticTxtTitulo= wx.StaticText(self, -1, _("AmpOp no inverter design output data"))  
        self.staticTxtTitulo.SetFont(wx.Font(18, wx.SWISS, wx.NORMAL, wx.BOLD))
        ...
        self.img1 = wx.Image("ampOpNaoInversor.png", wx.BITMAP_TYPE_ANY)
...
class ampOpNoInverterAmplifierDesign():
        
    
    def __init__(self):
    
        self.dialogo =  entradaNaoInversorAmpOp()      #cria um dialogo de solicitacao de parametros de entrada
        ...
        if self.result == wx.ID_OK:  
            ...
            self.dialogo2= saidaAmpOpNoInverter(self.RiStd,self.RfStd,self.RpStd,self.fcp, self.tr*1000000)
    ...
    def calculaCircuito(self):
        ...
        self.Rf= float(self.dialogo.GetRfTxt())
        self.Rs= float(self.dialogo.GetRsTxt())
        ...
        self.fcp= self.fop * self.avo * self.Ri/(self.Rf + self.Ri)
        
        #calculo de tr
        self.tr = 0.35 * (self.Ri + self.Rf)/(self.fop*self.avo*self.Ri)
